// To parse this data:
//
//   import { Convert, SerachGifsResponse } from "./file";
//
//   const serachGifsResponse = Convert.toSerachGifsResponse(json);
//
...
export class Convert {
    public static toSerachGifsResponse(json: string): SerachGifsResponse {
        return cast(JSON.parse(json), r("SerachGifsResponse"));
    }

    public static serachGifsResponseToJson(value: SerachGifsResponse): string {
        return JSON.stringify(uncast(value, r("SerachGifsResponse")), null, 2);
    }
}
